    ...
    return (
        <section className="relative grid min-h-screen w-full place-content-center overflow-hidden bg-neutral-950">
            <h2 className="relative z-0 text-[20vw] font-black text-neutral-800 md:text-[200px]">
                BIXELTEK<span className="text-purple-500">.</span>
            </h2>
            <p className="text-xs text-neutral-600 mt-[0px] max-w-[85%] lg:text-sm md:text-sm mx-auto text-center ">
            Bixeltek is a digital marketing agency focused on driving growth through innovative strategies in SEO, social media, and content marketing.
            </p>
            <Cards />
        </section>
    );
