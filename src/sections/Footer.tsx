      ...
      <div className="mx-auto max-w-[97%] px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 min-[690px]:grid-cols-4 lg:grid-cols-6 gap-4 xl:gap-8 pt-14 pb-10 max-w-xs mx-auto min-[690px]:max-w-2xl lg:max-w-full">
          ...
          <div className="lg:mx-auto text-left ">
            ...
            <ul className="text-sm flex gap-10  transition-all duration-500">
        ...
        <div className="py-7 border-t border-gray-200">
          <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            ...
            <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
              ...
              <a href="javascript:;" className="w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-purple-600 hover:bg-gray-900">
              ...
              <a href="http://instagram.com/bixeltekagency/" target="_blank" className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-purple-600 hover:bg-gradient-to-b from-gray-900 to-gray-900  
                        ">
              ...
              <a href="https://www.facebook.com/Bixeltek" target="_blank" className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-purple-500  hover:bg-gray-900 ">
              ...
              <a href="https://www.linkedin.com/company/bixeltek" target="_blank" className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-purple-500  hover:bg-gray-900 ">
