...
import { ServiceMegamenu } from '@/components/Megamenus/ServicesMegamenu';
...
export const Header = () => {
  ...
  return (
    <>
        ...
        <div className="container bg-black flex justify-between items-center border-white/15 border-solid border-2 rounded-xl shadow-purple-custom backdrop:blur-3xl">
          ...
          <div className="hidden md:block text-sm tracking-widest">
            <nav className="flex items-stretch">
              <ul className="flex gap-8 h-auto font-sans">
                <li className="flex items-center py-7">
                  <Link href="/" className="text-white/70 hover:text-white transition">
                    Home
                  </Link>
                </li>
                <li className="flex items-center py-7" onMouseEnter={handleMouseEnter}
      ...
      <ServiceMegamenu service={service} />
    </>
  );
};
