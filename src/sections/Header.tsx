                    ...
                    <div className="w-1/2">
                      ...
                      <div className="grid grid-cols-2 gap-4 px-4">
                        <ul>
                          ...
                          <li>
                            <Link href="/seo" className="block hover:bg-[#f5f3ff] p-3 rounded-lg transition">
                          ...
                          <li>
                            <Link href="/socialmedia" className="block hover:bg-[#f5f3ff] p-3 rounded-lg transition">
                        ...
                        <ul>
                          ...
                          <li>
                            <Link href="/services/service4" className="block hover:bg-[#f5f3ff] p-3 rounded-lg transition">
