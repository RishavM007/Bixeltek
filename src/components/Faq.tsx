            ...
            <div className="absolute bottom-0 right-0 z-[-1]">
                ...
                >
                    ...
                    <defs>
                        ...
                        >
                            <stop stopColor="#6A0DAD" stopOpacity="0.36" />
                            <stop offset="1" stopColor="#9B4DCA" stopOpacity="0" />
                            <stop offset="1" stopColor="#9B4DCA" stopOpacity="0.096144" />
                        </linearGradient>
                    </defs>
                </svg>
...
const AccordionItem: React.FC<AccordionItemProps> = ({ header, text }) => {
    ...
    return (
        <div className="mb-8 w-full rounded-lg bg-white p-4 shadow-[0px_20px_95px_0px_rgba(201,203,204,0.30)] dark:bg-dark-2 dark:shadow-[0px_20px_95px_0px_rgba(0,0,0,0.30)] sm:p-8 lg:px-6 xl:px-8">
            ...
            <div
                className={`overflow-hidden transition-[max-height] duration-300 ease-in-out ${active ? 'max-h-screen' : 'max-h-0'}`}
            >
