...
const ComparisonTable = () => {
  ...
  return (
    <section className="bg-black text-white max-w-[95%] mx-auto py-16 px-6">
      <div className="max-w-screen-xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        
        <div>
          <h2 className="text-5xl font-sofiasanscondensed font-bold mb-8">
        ...
        <div className="overflow-x-auto px-10">
          <h3 className="text-3xl font-sofiasanscondensed font-bold text-white pb-8 text-center">
          ...
          <table className="w-full text-left border-collapse">
            ...
            <thead>
              <tr className="border-b border-gray-600  text-white">
                <th className="py-3 text-left text-lg pl-5">Freelancer</th>
                <th className="py-3 text-left text-lg pl-10">Bixeltek Web Design Agency</th>
              </tr>
            </thead>
            ...
            <tbody>
              {tableData.map((row, index) => (
                <tr key={index} className="border-b  border-gray-700 hover:border-purple-500 transition-all">
                  <td className="py-5 text-gray-300 pl-5 text-left">
                    <span className="flex items-center justify-start gap-2">
                      <LiaTimesSolid className="text-red-500 text-lg" /> {row.freelancer}
                    </span>
                  </td>
                  <td className="py-5 text-white text-center pl-10">
                    <span className="flex items-center justify-start gap-2">
