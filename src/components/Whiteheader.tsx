                ...
                <div className="hidden md:flex text-[17px] tracking-widest">
                    <nav className="flex items-stretch">
                        <ul className="flex gap-8 h-auto font-sofiasanscondensed font-normal tracking-widest">
                            ...
                            <li className="flex items-center py-7">
                                <Link href="/casestudies-bixeltek/Tumblewash-Casestudy" className="text-black font-semibold hover:text-purple-800 transition flex items-center">
                                    Case Studies <HiChevronDown className="ml-1 text-xs" />
                                </Link>
                            </li>
                            <li className="flex items-center py-7">
                                <Link href="/thank-you" className="text-black hover:text-purple-800 font-semibold transition">
                                    Blog
                                </Link>
                            </li>
