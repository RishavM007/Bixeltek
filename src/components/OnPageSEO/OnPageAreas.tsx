        ...
        <section className="relative w-full py-24 px-6 md:px-16 bg-black text-white overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center mb-12">
                <h2 className="text-3xl md:text-6xl font-semibold mb-4">
                    Global Expertise,{" "}
                    <span className="text-blue-500">Localized Optimization </span>
                </h2>
                <p className="text-gray-300 text-lg">
                   Our On-Page SEO systems are adapted to regional search behavior and language nuances across :
                </p>
            </div>
            ...
            <p className="relative z-10 text-center text-gray-300 mt-12 max-w-2xl mx-auto">
               Each deployment includes localized schema, bilingual metadata, and intent-based keyword mapping.
            </p>
        </section>
    );
};

export default OnPageAreas;
