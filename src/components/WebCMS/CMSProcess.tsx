          ...
          return (
            <div key={idx} className="relative z-0">
              ...
              <div className="relative flex flex-col justify-between items-center z-10 bg-[#fffdf5] rounded-[20px] p-8 h-[260px]">
                {/* Floating Card */}
                <div
                  className={`absolute flex items-center gap-5 flex-row border border-white/40 bg-[#fffdf5] w-[85%]  lg:max-w-3xl shadow-[rgba(0,0,0,0.4)_0px_2px_4px,rgba(0,0,0,0.3)_0px_7px_13px_-3px,rgba(0,0,0,0.2)_0px_-3px_0px_inset] rounded-2xl p-10 z-10 transition-all duration-300 ${positionClasses}`}
                >
                  <div>
