...
export default function AreasWeServeCanadaVanc() {
   const regions = [
    {
      title: "Toronto & GTA",
      cities: [
      ...
      <div className="max-w-[95%] md:max-w-[85%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-6">
        ...
        <div>
          <h2 className="text-4xl md:text-6xl font-bold mb-6">
            SEO Services <span className="text-blue-500">Across Greater Vancouver</span>
          </h2>
          <p className="text-gray-300 text-lg mb-8">
             Bixeltek’s SEO solutions cover Vancouver and surrounding cities, helping local and regional businesses achieve online dominance.
          </p>
