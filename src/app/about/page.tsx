...
export default function AboutPage() {
  const timelineEvents = [
    ...
    },
    {
      ...
      description: "Develop IT solutions based on the analysis phase and make a report.",
    },
    {
  ...
  return (
    <>
      ...
      <div className="bg-black text-white">
        <section>
          <div className="relative isolate mt-[-120px] mb-[-70px] overflow-hidden bg-black h-[100vh] flex items-center justify-center">
            <svg
            ...
            <div className="max-w-full px-4 text-center lg:max-w-3xl">
              <h1 className="text-5xl font-bold tracking-tight text-white sm:text-6xl">
                About <span className="text-purple-500">Bixeltek</span>
              </h1>
              <p className="mt-10 text-sm lg:text-lg leading-8 text-gray-300">
                At <span className="text-purple-500 px-1">Bixeltek</span> we have
                worked with 100s of brands in the North American market, and our
                team has come a long way understanding the needs of each
                individual brand. <span className="hidden md:block">We are not
                freelancers, but we work as your in-house team that knows exactly
                what your business needs.</span>
              </p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-16">
            ...
            >
              ...
              <p className="text-lg md:text-[16px] leading-wide">
                ...
                your current IT infrastructure, workflows, and pain points.
              </p>
            ...
            >
              ...
              {timelineEvents.map((event, index) => (
                ...
                >
                  <div
                    className={`max-w-sm relative p-8 rounded-lg bg-black flex flex-col text-center justify-start shadow-lg z-[1] ${
