...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div className="flex justify-center items-center">
      {/* Left Label */}
      <label className="min-w-14 text-sm text-gray-500 me-3 dark:text-neutral-400">
        Monthly
      </label>
      ...
      <label className="relative flex items-center cursor-pointer">
        <input
          type="checkbox"
          className="sr-only" // Hides default checkbox for accessibility
          checked={isChecked}
          onChange={() => setIsChecked(!isChecked)}
        />
        {/* Background */}
        <div
          className={`w-[3.25rem] h-7 rounded-full transition-colors duration-300 ${
            isChecked ? "bg-blue-600 dark:bg-blue-500" : "bg-gray-300 dark:bg-neutral-700"
          }`}
        />
        {/* Animated Toggle */}
        <motion.div
          ...
          style={{
            left: isChecked ? "1.75rem" : "0.25rem",
          }}
        />
      </label>

      {/* Right Label with Discount Tag */}
