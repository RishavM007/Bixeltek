    ...
    <html lang="en">
      <body className={`${inter.className} bg-[black]`}>
        ...
        <a
          ...
          className="fixed bottom-10 z-50 right-20 flex items-center space-x-3"
        >
          <p className="text-white font-sofiasanscondensed tracking-wide text-lg">Need Help? <span className="font-bold">Chat with us</span></p>
